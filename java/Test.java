...
public class Test
{
	...
	private static void testMinimumHeap()
	{
		beginSection("MinimumHeap");
		try
		{
			MinimumHeap<Integer> heap1 = new MinimumHeap<Integer>();
			MinimumHeap<Integer> heap2 = new MinimumHeap<Integer>();
	...
	private static void testMaximumHeap()
	{
		beginSection("MaximumHeap");
		try
		{
			MaximumHeap<Integer> heap1 = new MaximumHeap<Integer>();
			MaximumHeap<Integer> heap2 = new MaximumHeap<Integer>();
			testHeap(heap1, heap2);
