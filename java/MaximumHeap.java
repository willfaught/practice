public class MaximumHeap<E extends Comparable<E>> implements Heap<E>
{
	private List<E> list;
	...
	public boolean equals(Object object)
	{
		...
		if (object == null || !(object instanceof MaximumHeap))
		{
			return false;
		}
		MaximumHeap<?> maximumHeap = (MaximumHeap<?>)object;
		return list.equals(maximumHeap.list);
	}
