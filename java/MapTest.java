...
{
    private static void test(Map<Integer, Integer> m)
    {
        m.clear();
    ...
    {
        test(new LinearProbingHashTable<Integer, Integer>());
        test(new LinearProbingHashTable<Integer, Integer>(10));
    }

    @Test
    public void linearSinglyLinkedMap()
    {
        test(new LinearSinglyLinkedMap<Integer, Integer>());
    }

    @Test
    public void separateChainingHashTable()
    {
        test(new SeparateChainingHashTable<Integer, Integer>());
        test(new SeparateChainingHashTable<Integer, Integer>(10));
    }
}